			...
			<tr>
				<td colspan=2> <font color=#5C3317> <center><b>Thanks for interested in hotel royel.</b></center><br><br></font></td>
      			...
      			<tr>
					...
					<font color=#5C3317>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<b>New Registration</b></font> <br/><br/>
					...
					<?php
						...
						pg_query("insert into registration values('".$fname."','".$lname."','".$bdt."',".$phno.",'".$gender."','".$email."','".$uname."','".$pwd."','".$cpwd."')");

						pg_query("insert into usr values('".$uname."','".$pwd."');");

						echo "<font color=#5C3317>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Your Registration is done sucessfully !! Now you are a member of our site.</font><br><br>";
					?>
