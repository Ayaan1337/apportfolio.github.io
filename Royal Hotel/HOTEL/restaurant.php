...
<tr>
    <td valign="top" style="padding-top:15px; padding-bottom:15px;">
		...
		<table width="94%" height="14" border="0" align="center" cellpadding="0" cellspacing="15">
      		<tr>
        		<td width="63%" valign="top">               		
				<font color=#5C3317> <b> welcome to our restaurant session !!</b> <br>

			   	<p align=justify>Internationally styled restaurants in Royel hotel,
			   	provide you a thoroughly restful serving to you. the Sessions of the word with some of the most inpressive food. 
			   	Sessions introduces a new concept in duisine to spice up your food life with a restaurant for family,lunch and entertainment.
				
				<bR> <br> <b>Timing</b> <br><br>   Lunch :12.00 to 15.30 hours <br><br> Dinner :19.00 to 23.30 hours   </font></p>

				<div><img src="images/img6.jpg" width="47%" height="180" alt="" />&nbsp&nbsp&nbsp&nbsp&nbsp

				<img src="images/img7.jpg" width="47%" height="180" alt="" /></div>
			</td>

        		<td width="37%" valign="top">
				
				<div><img src="images/img5.png" width="100%" height="180" alt="" /></div>
				<div><font face="Tahoma" size=5 color=#CB7C3D>&nbsp&nbsp&nbsp Menu</font></div>
				<div class="body1">
                        		<ul class="list3">
                     				<li>Specials</li>
                        			<li>Lunch</li>
