			...
			<tr>
				<td colspan=2>
      			...
      			<tr>
					...
					<br><br> <font color=#5C3317>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<b> Cancel Reservation </b></font> <br/><br/>

					<?php
						include "cancel_reservation.php";
					?>
					...
					<br><br><div style="text-align:center"><img src="images/img3.jpg" width="100%" height="160" alt="" /></div>
					
					<br><br><div style="text-align:center"><img src="images/img2.jpg" width="100%" height="160" alt="" /></div>
					
					<br><br><div style="text-align:center"><img src="images/img4.jpg" width="100%" height="160" alt="" /></div>
				</td>
      			</tr>
    		</table>
