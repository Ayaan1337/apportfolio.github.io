			...
			<tr>
				<td colspan=2> <font color=#5C3317> <center><b>Thanks for interested in hotel royel.</b></center><br><br></font></td>
      			...
      			<tr>
					...
					<font color=#5C3317>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<b>cancel Reservation</b></font> <br/><br/>
					...
					<?php
						...
						$resv= pg_query("select * from reservation where res_id='".$rid."'");
						pg_query("delete from reservation where res_id='".$rid."'");

						pg_query("delete from payment where r_id='".$rid."'");		

						echo "<font color=#5C3317>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Your Reservation is cancel sucessfully !! </font><br><br>";
