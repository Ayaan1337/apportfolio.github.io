...
<tr>
    <td valign="top" style="padding-top:15px; padding-bottom:15px;">
		...
		<tr>
				...
				<br> <font color=#5C3317> <b>Tariff and Policies :</b> </font><br><br> 

				<?php
					include "tariff.php";
				?>
				
				<br><font color=#5C3317> <b>Policies :</b></font>
				
				<ul type=disc><font color=#5C3317>
 
					<li>Check in 12 hours.

					<li>Check out 12 hours.

					<li>Early arrival is subject to availability,For guaranted early check in,reservation needs<br> to be made starlings form previous night.
					
					<li>Goverment taxes & levies extra as applicable.
				</ul>
				

				<font color=#5C3317><b> Reservation Guarantee :</b></font>
				
				<ul type=disc><font color=#5C3317> 
					<li>All booking must be guaranteed at time of reservation by payment.</font>
				</ul>	
				

				<font color=#5C3317><b> Reservation Cancelation :</b></font>
				<ul type=disc><font color=#5C3317> 
					<li>Reservation must be cancelled 24 hours prior to the planned arrival time.
					<li>One night room charge will be levied in case of non arrival.</font>
				</ul>
				...
				<div style="text-align:center"><img src="images/img6.jpg" width="100%" height="190" alt="" /></div><br><br>
				<div style="text-align:center"><img src="images/img7.jpg" width="100%" height="190" alt="" /></div>
			</td>
      		</tr>
    	</table>
