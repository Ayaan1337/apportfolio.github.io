...
$resc=pg_query("select * from reservation ORDER BY count");

while($rv = pg_fetch_array($resc))
{
...
{
	pg_query("insert into reservation values('R-".$count."','" . $indate ."','". $outdate."'," .$nor.",'".$type."','".$name."','".$email."','".$company."',".$contact.",'".$address."','".$spereq."',".$count.")");
	
	//pg_query("update room set reserv_room = reserv_room +".$nor.", avail_room=avail_room-".$nor." where type='".$type."'");
